...
const forumPostData = [
  ...
  },
  {
    ...
    post_content:
      "I like most of us here ONLY like games that CCG claims to make.  There is the new game called  Isle of Cats that most of my friends on the Feline Facebook group won't stop purring about.  Let's make some noise on these forums so we can get CCG to add this game to their collection so I can finally start liking it as well!!!",
